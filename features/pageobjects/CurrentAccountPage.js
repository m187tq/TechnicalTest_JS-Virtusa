...
class CurrentAccountPage extends AbstractPage {
    get chooseCurrentAccountText() {
        return $("div.c-106-grid-layout:nth-child(4) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > h2:nth-child(1)");
    }
    get classicAccount() {
...
module.exports = new CurrentAccountPage();